...
documentTitles["startinginstanceclient.html#starting-the-cluster-and-client"] = "Starting the Cluster and Client";
index.add({
    url: "startinginstanceclient.html#starting-the-cluster-and-client",
...
documentTitles["faq.html#which-virtualization-should-i-use-on-aws"] = "Which virtualization should I use on AWS";
index.add({
    url: "faq.html#which-virtualization-should-i-use-on-aws",
