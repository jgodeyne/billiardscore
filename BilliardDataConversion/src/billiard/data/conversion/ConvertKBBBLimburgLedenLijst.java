 ...
 * @author jean
 */
public class ConvertKBBBLimburgLedenLijst {
    private static final Logger LOGGER = Logger.getLogger(ConvertKBBBLimburgLedenLijst.class.getName());
    private static final String LEAGUE_NAME = "KBBB - Limburg";
    ...
    public static void main(String[] args) throws Exception {
        LogManager.getLogManager().readConfiguration(ConvertKBBBLimburgLedenLijst.class.getResourceAsStream("/logging.properties"));
        Path dir = Paths.get("input/kbbb/Ledenlijst-KBBB-Limburg.csv");
        convertFile(dir);
            ...
            while (itRecords.hasNext()) {
                ...
                if(!csvRecord.get(0).isEmpty()) {
                    ...
                    if(!csvRecord.get(8).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("K57/2");
                        tsp.setTsp(csvRecord.get(8));
                        member.putTsp(tsp);
                    }
                    if(!csvRecord.get(9).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("Vrijspel (GB)");
                        tsp.setTsp(csvRecord.get(9));
                        member.putTsp(tsp);
                    }
                    if(!csvRecord.get(10).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("Band (GB)");
                        tsp.setTsp(csvRecord.get(10));
                        member.putTsp(tsp);
                    }
                    if(!csvRecord.get(11).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("Drieband (GB)");
                        tsp.setTsp(csvRecord.get(11));
                        member.putTsp(tsp);
                    }
                    if(!csvRecord.get(12).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("K47/2");
                        tsp.setTsp(csvRecord.get(12));
                        member.putTsp(tsp);
                    }
                    if(!csvRecord.get(13).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("K47/1");
                        tsp.setTsp(csvRecord.get(13));
                        member.putTsp(tsp);
                    }
                    if(!csvRecord.get(14).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("Vrijspel (KB)");
                        tsp.setTsp(csvRecord.get(14));
                        member.putTsp(tsp);
                    }
                    if(!csvRecord.get(15).equals("0")) {
                        TSPItem tsp = new TSPItem();
                        tsp.setDiscipline("K71/2");
                        tsp.setTsp(csvRecord.get(15));
                        member.putTsp(tsp);
                    }
